...
This guide is based on the steps in the [ESM Preprocessing Gallery](https://preprocess.esmtools.com/) and further described in the following paper: 

* Revol, J., Carlier, C., Lafit, G., Verhees, M., Sels, L., & Ceulemans, E. (in preparation). _Preprocessing ESM data: A step-by-step framework, reporting templates, and R code website._
